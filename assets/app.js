(() => {
  ...
  const COPY = {
    ko: {
      ...
      rankingEntryRankerDisplay: "실시간 랭커 아이콘은 전체 기간 또는 이번 주 구간 TOP 20, 랭커 닉네임 효과 무료 권한은 두 기간 중 한 곳의 TOP 3부터 적용됩니다. 현재 감지 CP는 해당 기록과 같은 25K 구간이어야 하며, 선택한 효과는 자격이 다시 확인되면 자동 복원됩니다.",
      ...
      rankerDungeonGuideEffectChip: "효과 TOP 3 또는 쿠폰",
      ...
      rankerDungeonGuideMarkerBody: "두 기간 중 하나만 충족하면 표시됩니다. 같은 보스·직업·25K CP 구간의 개별 순위로 판정합니다.",
      rankerDungeonGuideEffectLabel: "닉네임 효과",
      rankerDungeonGuideEffectTitle: "쿠폰 또는 구간 TOP 3 — 하나만 필요",
      rankerDungeonGuideEffectBody: "쿠폰과 랭커 조건을 동시에 충족할 필요가 없습니다. 전체 기간·이번 주 중 한 곳의 TOP 3도 무료 사용 조건으로 인정됩니다.",
      rankerDungeonGuideFlowAria: "닉네임 효과 반영 순서",
      rankerDungeonGuideUseTitle: "언제부터 사용할 수 있나요?",
      rankerDungeonGuideUseBody: "쿠폰은 등록 성공 즉시 사용할 수 있습니다. 랭커 권한은 다음 랭킹 캐시가 게시되고 미터기가 자격을 확인한 뒤 활성화됩니다. 통계 집계는 매시 정각과 30분에 시작하며 처리 시간만큼 늦어질 수 있습니다.",
      ...
      rankerDungeonGuideRetentionBody: "현재 CP가 자격을 얻은 25K 구간을 벗어나거나 TOP 3 자격을 잃으면 랭커 권한 효과는 숨겨집니다. 선택한 효과는 지워지지 않으며, 같은 구간에서 자격이 다시 확인되면 자동 복원됩니다. 유효한 쿠폰 권한은 랭킹과 무관합니다.",
      ...
      rankerDungeonGuidePeriod: "이번 주 랭킹은 매주 수요일 오전 5시부터 다음 수요일 오전 5시까지입니다. 전체 기간과 이번 주는 별도로 집계하며, 둘 중 더 유리한 자격을 사용할 수 있습니다.",
      ...
      weeklyGuideRanking: "직업 순서는 이번 주 상위 25% DPS로 정렬합니다. 구간 1~20위와 TOP 3 닉네임 효과 권한은 전체 기간 또는 이번 주 중 하나만 충족해도 인정하며, 보스 처치 후 상위 %는 전체 기간 기준을 유지합니다.",
    ...
    en: {
      ...
      rankingEntryRankerDisplay: "The live ranker icon requires a Top 20 bracket rank in either all-time or the current week. Free ranker nickname-effect access starts at Top 3 in either period. The detected CP must remain in the same 25K bracket, and a saved effect returns automatically when eligibility is verified again.",
      ...
      rankerDungeonGuideEffectChip: "Effect: Top 3 or coupon",
      ...
      rankerDungeonGuideMarkerBody: "Qualifying in either period is enough. Ranking is evaluated per boss, class, and fixed 25K CP bracket.",
      rankerDungeonGuideEffectLabel: "NICKNAME EFFECT",
      rankerDungeonGuideEffectTitle: "Coupon or bracket Top 3 — only one is required",
      rankerDungeonGuideEffectBody: "You do not need both a coupon and rank eligibility. Top 3 in either all-time or the current week also grants free access.",
      rankerDungeonGuideFlowAria: "Nickname-effect activation timeline",
      rankerDungeonGuideUseTitle: "When can I use it?",
      rankerDungeonGuideUseBody: "A redeemed coupon works immediately. Ranker access activates after the next ranking snapshot is published and the meter verifies it. Statistics generation starts at :00 and :30 each hour; processing can add delay.",
      ...
      rankerDungeonGuideRetentionBody: "A rank-granted effect is hidden if your detected CP leaves the qualifying 25K bracket or Top 3 eligibility is lost. The selected effect is kept and returns when eligibility is verified again. An active coupon is independent of ranking.",
      ...
      rankerDungeonGuidePeriod: "The current week runs from Wednesday 05:00 KST to the following Wednesday 05:00 KST. All-time and current-week rankings are calculated separately, and the qualifying result can be used.",
      ...
      weeklyGuideRanking: "Classes are sorted by this week's top-25% DPS. Bracket Top 20 and Top 3 nickname-effect access qualify from either all-time or current-week records, while post-combat Top % remains all-time.",
