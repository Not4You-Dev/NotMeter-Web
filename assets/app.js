(() => {
  ...
  const COPY = {
    ko: {
      ...
      rankingEntryRankerDisplay: "실시간 랭커 아이콘과 랭커 닉네임 효과는 전체 기간 또는 이번 주 구간 1~20위 중 하나를 충족하면 적용됩니다. 현재 감지 CP는 해당 기록과 같은 25K 구간이어야 하며, 선택한 스킨은 자격이 다시 확인되면 자동 복원됩니다.",
      ...
      rankerDungeonGuideIntro: "현재 딜미터기 구간 랭커 마크(TOP 20)는 아래 7개 콘텐츠에서 각 보스·직업·CP 구간별로 표시됩니다.",
      ...
      rankerDungeonGuidePeriod: "딜미터기 랭커 마크와 닉네임 효과는 전체 기간 또는 이번 주 구간 랭킹 중 하나만 충족해도 적용됩니다. 이번 주는 매주 수요일 오전 5시에 갱신되며, 현재 감지 CP가 해당 25K 구간을 벗어나면 즉시 숨겨집니다.",
    ...
    en: {
      ...
      rankingEntryRankerDisplay: "The live ranker icon and ranker nickname effect apply when either the all-time or current-week bracket rank is within the Top 20. The detected CP must remain in the same 25K bracket as that record, and a saved skin returns automatically when eligibility is verified again.",
      ...
      rankerDungeonGuideIntro: "The live meter Top 20 rank marker is currently available for the seven contents below, separated by boss, class, and CP bracket.",
      ...
      rankerDungeonGuidePeriod: "The live ranker marker and nickname effect apply when either the all-time or current-week bracket ranking qualifies. The week resets Wednesday at 05:00 KST, and both are hidden immediately outside the matching 25K bracket.",
