(() => {
  ...
  const COPY = {
    ko: {
      ...
      rankingEntryRankerDisplay: "상위 %는 nDPS 우선 설정에서 800K 미만은 전체 기간 nDPS, 800K 이상은 이번 주 nDPS를 우선 사용하고 nDPS가 없으면 DPS로 표시합니다. 랭커 표시와 랭커 권한 닉네임 효과는 800K 이상에서 전체 기간 DPS 또는 이번 주 nDPS 순위로 판정하며, 유효한 쿠폰 효과는 CP 제한이 없습니다.",
      ...
      rankerDungeonGuideMarkerTitle: "전체 기간 DPS 또는 이번 주 nDPS 구간 TOP 20",
      rankerDungeonGuideMarkerBody: "전투력 800K 이상에서 두 기준 중 하나만 충족하면 표시됩니다. 같은 보스·직업·25K CP 구간의 개별 순위로 판정합니다.",
      rankerDungeonGuideEffectLabel: "닉네임 효과",
      rankerDungeonGuideEffectTitle: "전체 기간 DPS 또는 이번 주 nDPS 구간 TOP 3",
      rankerDungeonGuideEffectBody: "전투력 800K 이상에서 전체 기간 DPS와 이번 주 nDPS 중 한 곳의 TOP 3를 달성하면 랭커 닉네임 효과를 사용할 수 있습니다. 유효한 쿠폰 효과는 CP 제한이 없습니다.",
    ...
    en: {
      ...
      rankingEntryRankerDisplay: "With Prefer nDPS, Top % uses all-time nDPS below 800K CP and current-week nDPS at 800K CP or above, falling back to DPS when nDPS is unavailable. At 800K CP or above, ranker markers and ranker-granted nickname effects use either all-time DPS or current-week nDPS rank. Active coupon effects have no CP restriction.",
      ...
      rankerDungeonGuideMarkerTitle: "Top 20 by all-time DPS or current-week nDPS",
      rankerDungeonGuideMarkerBody: "At 800K CP or above, qualifying under either metric is enough. Ranking is evaluated per boss, class, and fixed 25K CP bracket.",
      rankerDungeonGuideEffectLabel: "NICKNAME EFFECT",
      rankerDungeonGuideEffectTitle: "Top 3 by all-time DPS or current-week nDPS",
      rankerDungeonGuideEffectBody: "At least 800K CP is required for ranker eligibility. Reaching Top 3 by either all-time DPS or current-week nDPS unlocks the ranker nickname effect. Active coupon effects have no CP restriction.",
