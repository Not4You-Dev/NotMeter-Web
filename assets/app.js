(() => {
  ...
  const COPY = {
    ko: {
      ...
      rankerDungeonGuideEffectBody: "두 기간 중 한 곳에서 TOP 3를 달성하면 랭커 닉네임 효과를 사용할 수 있습니다. 같은 보스·직업·25K CP 구간의 개별 순위로 판정합니다.",
    ...
    en: {
      ...
      rankerDungeonGuideEffectBody: "Reaching Top 3 in either period unlocks the ranker nickname effect. Ranking is evaluated per boss, class, and fixed 25K CP bracket.",
