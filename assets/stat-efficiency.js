(() => {
  ...
  const TEXT = {
    ko: {
      ...
      noticeTitle: "계산 기준", notice: "입력한 치명타·강타·공격 방향 조건을 적용한 공통 피해 기대값입니다. 직업별 스킬 비중, 재사용 시간과 실전 딜 사이클 변화는 반영하지 않습니다. 옵션 반영 후 유효하지 않은 공격 수치는 계산하지 않습니다.",
    ...
    en: {
      ...
      noticeTitle: "Calculation basis", notice: "Common expected damage under your critical, hard-hit and direction assumptions. Class skill mix, cooldowns and rotation changes are not modeled. Invalid final attack values cannot be calculated.",
    ...
    "zh-TW": {
      ...
      noticeTitle: "計算依據", notice: "依輸入的暴擊、強擊與攻擊方向計算共通期望傷害，不包含各職業技能比重、冷卻與輸出循環變化。套用選項後無效的攻擊數值不予計算。",
